...
public class GetProductById {
    public String ValidEndpointGetProductById = "https://altashop-api.fly.dev/api/products/13347";
    ...
    public void validateValidDataForProductByID(){
        restAssuredThat(response->response.body("data.Name",equalTo("XBox 1")));
        restAssuredThat(response->response.body("data.Description",equalTo("")));
        restAssuredThat(response->response.body("data.Price",equalTo(499)));
    }
}
