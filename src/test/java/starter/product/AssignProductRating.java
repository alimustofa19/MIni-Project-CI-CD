...
public class AssignProductRating {
    public String ValidEndpointAssignProductRating = "https://altashop-api.fly.dev/api/products/13347/ratings";
    public String InvalidEndpointAssignProductRating = "https://altashop-api.fly.dev/api/products/12237/rating";
    public String EndpointProductAssignRatingWithoutReqData = "https://altashop-api.fly.dev/api/products/13348/ratings";
